						...
						<div class="store-seat-block">
										...
										$.ajax({
											...
											success: function(data){
												...
												if(type == 1){
													...
													$("#dislike_"+postid).css("background-color","#ff3a6d");
													$("#dislike_"+postid).attr("disabled", false);
												}

												if(type == 0){
													$("#dislike_"+postid).css("background-color","#A0A0A0");
													$("#dislike_"+postid).attr("disabled", true);
													$("#like_"+postid).css("background-color","#ffcb0f");
							...
							if ($flags == 1){ // loged in able to like and dislike
								...
								if($type == 1){
									echo'<div class="upvote-btn">';
									echo '<div class="featured-btn-wrap">';
										echo '<button class="btn know_btn like" id="like_'.$review_id.'" name="upvote" style="font-size: 14px; background: #A0A0A0;" disabled>UPVOTE</button>';
									echo '</div>';
									echo '</div>';
									echo '<div class="downvote-btn">';
										echo '<button class="btn btn-outline-danger dislike" id="dislike_'.$review_id.'" name="downvote" style="font-size: 14px">DOWNVOTE</button>';
								...
								if($type == 0){
									...
									echo '</div>';
									echo '<div class="downvote-btn">';
										echo '<button class="btn btn-outline-danger dislike" id="dislike_'.$review_id.'" name="downvote" style="font-size: 14px; background: #A0A0A0;" disabled>DOWNVOTE</button>';
									echo '</div>';
								}
				...
				<div class="row">
					<div class="col-md-8 responsive-wrap">
						...
						<div  id="comments_box" class="review-checkbox_wrap mt-4">
							...
							for($i=0; $i<$num && $i<3; $i++){ // 3 comments at a time
